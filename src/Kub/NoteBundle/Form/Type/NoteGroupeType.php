...
use Kub\NoteBundle\Form\Type\NoteSingleType ;
...
class NoteGroupeType extends AbstractType
{
	...
	public function __construct(\Kub\ClasseBundle\Entity\Groupe $groupe, \Kub\UserBundle\Entity\Professeur $professeur)
	{
		$this->eleves = $groupe->getEleves() ;
		$this->groupe = $groupe ;
	...
	{
		$builder->add('matiere', 'entity', array(
