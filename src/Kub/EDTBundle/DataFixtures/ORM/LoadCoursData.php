...
class LoadCoursData extends AbstractFixture implements FixtureInterface, ContainerAwareInterface, OrderedFixtureInterface
{
	...
	public function load(ObjectManager $manager)
	{
		$cours = new Cours;
			...
			$horaire1->addSemaine( $this->getReference('semaine10-14') );
			...
			$horaire2->addSemaine( $this->getReference('semaine10-14') );
			...
			$horaire3->addSemaine( $this->getReference('semaine10-14') );
